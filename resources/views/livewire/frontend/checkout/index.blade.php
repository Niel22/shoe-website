                        ...
                        <div class="tp-checkout-verify-item">
                            <p class="tp-checkout-verify-reveal">Returning customer?
                                <button type="button" wire:click="login"
                                    ...
                                    <span wire:loading.remove wire:target="login">Click here to login</span>
                                    <span wire:loading wire:target="login">Redirecting to login</span>
                                </button></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="tp-checkout-verify-item">
                            <p class="tp-checkout-verify-reveal">New customer?
                                <button type="button" wire:click="register"
                                    class="tp-checkout-login-form-reveal-btn">
                                    <span wire:loading.remove wire:target="register">Click here to Register</span>
                                    <span wire:loading wire:target="register">Redirecting to register</span>
                                </button></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-5">
                ...
                <div class="tp-checkout-place white-bg">
                    ...
                    <div class="tp-checkout-btn-wrapper">
                        ...
                        <button wire:loading wire:target="{{ url('/payment') }}" type="submit" class="tp-checkout-btn w-100">Redirecting</button>
                    </div>
                </div>
                </form>
            </div>
