                ...
                <div class="tp-login-option">
                   <div class="tp-login-input-wrapper">
                      <div class="tp-login-input-box">
                         <div class="tp-login-input">
                            <input wire:model="name" id="name" type="text" placeholder="Murtala Bolanle" style="@error('name') border: 1px solid red @enderror">
                         </div>
                      ...
                      <div class="tp-login-input-box">
                         <div class="tp-login-input">
                            <input wire:model="email" id="email" type="email" placeholder="bolanle@mail.com" class="@error('email') border: 1px solid red @enderror">
                         </div>
                         <div class="tp-login-input-title">
                   ...
                   <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                      <div class="tp-login-remeber">
                         ...
                         <label for="terms">I accept the terms of the Service &amp; <a href="#">Privacy Policy</a>.</label>
                         @error('terms')
                                <span class="text-sm text-danger">{{ $message }}</span>
                           @enderror
                      </div>
                   ...
                   <div class="tp-login-bottom">
                      <button wire:loading.remove wire:target="create" type="submit" class="tp-login-btn w-100">Sign Up</button>
                      <button wire:loading wire:target="create" type="button" class="tp-login-btn w-100">Checking Credentials...</button>
                   </div>
                </div>
            </form>
             </div>
