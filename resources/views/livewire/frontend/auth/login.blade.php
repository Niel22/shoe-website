          ...
          <div class="col-xl-6 col-lg-8">
             <div class="tp-login-wrapper">
                <div class="tp-login-top text-center mb-30">
                   <h3 class="tp-login-title">Login to Berry Shoes Store.</h3>
                ...
                <div class="tp-login-option">
                   <div class="tp-login-input-wrapper">
                      <div class="tp-login-input-box">
                         <div class="tp-login-input">
                            <input id="email" wire:model="email" type="email" placeholder="berryshoes@mail.com">
                         </div>
                   ...
                   <div class="tp-login-bottom">
                      <button wire:loading.disable wire:loading.remove wire:target="store" type="submit" class="tp-login-btn w-100">Login</button>
                      <button wire:loading wire:target="store" type="submit" class="tp-login-btn w-100">Checking Credentials...</button>
                   </div>
                </div>
            </form>
             </div>
