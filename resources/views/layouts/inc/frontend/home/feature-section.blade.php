                ...
                <div class="tp-featured-slider-active swiper-container">
                   <div class="swiper-wrapper">
                      <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                         <div class="tp-featured-thumb include-bg" data-background="frontend/img/product/slider/product-slider-1.jpg"></div>
                      ...
                      <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                         <div class="tp-featured-thumb include-bg" data-background="frontend/img/product/slider/product-slider-2.jpg"></div>
                         <div class="tp-featured-content">
                            <h3 class="tp-featured-title">
                      ...
                      <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                         <div class="tp-featured-thumb include-bg" data-background="frontend/img/product/slider/product-slider-3.jpg"></div>
                         <div class="tp-featured-content">
                            <h3 class="tp-featured-title">
