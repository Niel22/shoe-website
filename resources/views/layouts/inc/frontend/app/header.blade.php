                   ...
                   <div class="tp-header-top-right tp-header-top-black d-flex align-items-center justify-content-end">
                      <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                         ...
                         <div class="tp-header-top-menu-item tp-header-currency">
                            <span class="tp-header-currency-toggle" id="tp-header-currency-toggle">NGN</span>
                            <ul>
                               <li>
                                  <a href="#">NGN</a>
                               </li>
                         ...
                         <div class="tp-header-top-menu-item tp-header-setting">
                            ...
                            <ul>
                               ...
                               <li>
                                  <a style="cursor: pointer;" onclick="document.getElementById('logout').submit()">Logout</a>
                               </li>
                         ...
                         <nav class="tp-main-menu-content">
                            <ul>
                                <li class="has-dropdown">
                                    <a href="{{ url('/collection') }}">All Collections</a>
                                    <ul class="tp-submenu">
                      ...
                      <div class="tp-header-bottom-right d-flex align-items-center justify-content-end pl-30">
                         <div class="tp-header-search-2 d-none d-sm-block">
                            <form action="{{ url('/collection') }}">
                               <input type="text" placeholder="Search for Shoes of your preference...">
                               <button type="submit">
