...
namespace App\Livewire\Frontend\Collections;
...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        ->when($this->priceInput, function ($q) {
            ...
            ->select(['id', 'slug', 'name', 'selling_price', 'original_price', 'small_description', 'category_id'])
            ->paginate(10);
        ...
        return view('livewire.frontend.collections.index', compact('categories', 'colors'), [
            'products' => $products,
        ]);
    }
}
